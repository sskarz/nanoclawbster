...
function readSecrets(): Record<string, string> {
  // COMPOSIO_WEBHOOK_URL and RETELL_* are not strictly secrets but use this
  // path to reach the container. They are NOT in SECRET_ENV_VARS so they
  // won't be stripped from agent Bash commands.
  return readEnvFile([
